...
cd /opt/
download "https://raw.githubusercontent.com/zyuwl/fengzi-cdn/main/cdnfly/$tar_gz_name" "https://raw.githubusercontent.com/zyuwl/fengzi-cdn/main/cdnfly/$tar_gz_name" "$tar_gz_name"
...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	wget https://raw.githubusercontent.com/zyuwl/fengzi-cdn/main/cdnfly/api.py -O /opt/venv/lib/python2.7/site-packages/requests/api.py
